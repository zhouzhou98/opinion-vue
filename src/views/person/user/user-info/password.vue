      ...
      <div  class="text item">
        <el-form ref="form" :model="user"  label-width="70px" size="mini">
          <el-form-item label="旧密码">
            <el-input  clearable style="width:40%" type="password" v-model="user.oldPad" placeholder="请输入旧密码"></el-input>
          </el-form-item>
          <el-form-item label="新密码" label-width="70px">
            <el-input  clearable style="width:40%" type="password" v-model="user.newPad" placeholder="请输入新密码" ></el-input>
          </el-form-item>
          <el-form-item label="确认密码" label-width="70px">
            <el-input  clearable style="width:40%" type="password" v-model="user.conPad" placeholder="请输入密码" ></el-input>
          </el-form-item>
          <el-form-item>
  ...
  export default {
    ...
    methods: {
      updatePad(user){
        ...
        this.req.oldPad=md5(user.oldPad)
        var newPad=user.newPad
        var conPad=user.conPad
        if(newPad==null||conPad==null||newPad!=conPad){
